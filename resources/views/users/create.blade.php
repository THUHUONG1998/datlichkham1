                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="manhanvien" type="text" id="manhanvien" class="form-control" placeholder="Danh số" value= "{{old('manhanvien')}}">
                                                </div>
                                                @error('manhanvien')
                                                    <p style="color: red;"><i><b>{{$message}}</b></i></p>
                                                @enderror
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name = "ngaysinh" type="text" class="form-control" placeholder="dd/mm/yyyy"> </div>
                                            </div>
                                        </div>
